...
public class AbdominalExercises extends RepetitionAct {
    private boolean helped;

    //region Constructors
    public AbdominalExercises(int id, int idUser, int nRepetitions, boolean helped) {
        super(id, idUser, nRepetitions);
        this.helped = helped;
    }

    public AbdominalExercises(AbdominalExercises abdominalExercises) {
